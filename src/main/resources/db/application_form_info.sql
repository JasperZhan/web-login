...
(
    ...
    `education`                            char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学历（0 大学本科/ 1 研究生）',
    `academic_degree`                      char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学位（0 学士/ 1 硕士/ 2 博士）',
    ...
    `application_category`                 char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '申请类别（0 博士/ 1 正高职称/ 2 博士后）',
    `phone`                                varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '手机',
    ...
    `years_of_contract_signing_in_huizhou` float(6,2) NULL DEFAULT NULL COMMENT '在惠签约工作年限',
    ...
    `amount_of_housing_application`        decimal(20,4) NULL DEFAULT NULL COMMENT '以申请住房补贴金额 （单位/元）',
